...
import { seedSecurityX } from '@/lib/seed/securityx-questions';

export const runtime = 'nodejs';

/**
 * One-shot admin endpoint to seed the CompTIA SecurityX bundle (vendor +
...
export async function POST() {
  ...
  await db.adminLog.create({
    data: {
      adminId: user.id!,
      action: 'seed.securityx',
      targetType: 'Bundle',
      targetId: 'comptia-securityx',
