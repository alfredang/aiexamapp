...
import { seedGcpPca } from '@/lib/seed/gcp-pca-questions';

export const runtime = 'nodejs';

/**
 * One-shot admin endpoint to seed the Google Professional Cloud
 * Architect bundle (vendor + 3 practice exams + 195 questions +
...
export async function POST() {
  ...
  await db.adminLog.create({
    data: {
      ...
      action: 'seed.gcp-pca',
      targetType: 'Bundle',
      targetId: 'google-professional-cloud-architect',
