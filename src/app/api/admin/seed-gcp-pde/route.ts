...
import { seedGcpPde } from '@/lib/seed/gcp-pde-questions';

export const runtime = 'nodejs';

/**
 * One-shot admin endpoint to seed the Google Professional Data Engineer
 * bundle (vendor + 3 practice exams + 195 questions + bundle) into the
 * current database. Idempotent — safe to call repeatedly; rewrites
 * questions tagged `generatedBy: 'manual:gcp-pde-seed'`.
 *
...
export async function POST() {
  ...
  await db.adminLog.create({
    data: {
      ...
      action: 'seed.gcp-pde',
      targetType: 'Bundle',
      targetId: 'google-professional-data-engineer',
