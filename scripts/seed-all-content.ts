...
const SCRIPTS = [
  ...
  'scripts/seed-aws-dea-c01-topup.ts',
  'scripts/seed-scrum-org-psm-i-topup.ts',
  'scripts/seed-github-foundations-topup.ts',
  'scripts/seed-microsoft-az-500-topup.ts',
  'scripts/seed-microsoft-dp-203-topup.ts',
  'scripts/seed-microsoft-dp-100-topup.ts',
  'scripts/seed-google-ace-topup.ts',
  'scripts/seed-microsoft-ms-102-topup.ts',
  'scripts/seed-microsoft-dp-300-topup.ts',
  'scripts/seed-microsoft-md-102-topup.ts',
  'scripts/seed-microsoft-pl-300-topup.ts',
  'scripts/seed-microsoft-sc-200-topup.ts',
  'scripts/seed-microsoft-ai-102-topup.ts',
  'scripts/seed-cisco-ccna-topup.ts',
  'scripts/seed-aws-dop-c02-topup.ts',
  'scripts/seed-google-pro-ml-topup.ts',
